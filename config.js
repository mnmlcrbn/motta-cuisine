module.exports = {
  ...
  siteUrl: 'https://optimistic-swanson-9e6e4f.netlify.com/', // Domain of your website without pathPrefix.
  ...
  googleTagManagerID: '61352505-1', // GTM tracking ID.
  disqusShortname: 'gatsby-business-starter', // Disqus shortname.
  userName: 'Vaibhav Sharma',
  userTwitter: 'vaibhaved',
  userLocation: 'Delhi NCR, India',
  userDescription: '',
  copyright: 'Copyright © Motta Cuisine 2018-2019. All Rights Reserved.', // Copyright string for the footer of the website and RSS feed.
